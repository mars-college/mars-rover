...
1. `$ sudo apt-get install p7zip python3-serial minicom Jetson.GPIO udhcpc -y`
...
* This service is enabled at boot after the installation script complete. To disable, run `$ sudo systemctl disable simcom_wwan@wwan0.service`
