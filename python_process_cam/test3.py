...
#################
    ...
    # Compile shaders
    shader = OpenGL.GL.shaders.compileProgram(OpenGL.GL.shaders.compileShader(getFileContent("equirectanguler.vert"), GL_VERTEX_SHADER),
                                              OpenGL.GL.shaders.compileShader(getFileContent("equirectanguler.frag"), GL_FRAGMENT_SHADER))
